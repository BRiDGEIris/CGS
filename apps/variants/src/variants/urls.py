...
urlpatterns = patterns('variants',
    ...
    url(r'^api/variants/(?P<pk>[a-zA-Z0-9_-]{1,30})/(?P<action>[a-zA-Z]{1,30})/$', api.VariantDetail.as_view(),name='variant-detail'),
    url(r'^api/variants/(?P<pk>[a-zA-Z0-9_-]{1,30})/$', api.VariantDetail.as_view(),name='variant-detail'),
